...
const _masterProjects = [
  { title: 'Cashier Application', category: 'app', desc: 'A desktop cashier system built in C# that handles product listings, transactions, and receipt generation. Designed for small retail use cases with a clean and intuitive UI.', tech: 'C#, .NET, Windows Forms', github: 'https://github.com/NeoKazaki', demo: '', image: null, dateAdded: 'April 25, 2026' },
  { title: 'TypePhoon Game', category: 'game', desc: 'A typing speed game where players race against a storm by typing falling words correctly. Built to improve typing accuracy and speed in a fun, interactive way.', tech: 'Java, Game Logic, OOP', github: 'https://github.com/NeoKazaki', demo: '', image: null, dateAdded: 'April 25, 2026' },
