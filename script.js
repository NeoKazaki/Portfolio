...
// Initial render
// (artworks array is refreshed after seed below)
...
// Force-reset projects to latest data every load
const _masterProjects = [
  ...
  },
  {
    ...
    category: 'web',
    desc: 'My personal portfolio website showcasing my projects, artworks, skills, and achievements. Built with HTML, CSS, and JavaScript featuring dark/light mode, animated backgrounds, admin-protected content management, and responsive design.',
    tech: 'HTML, CSS, JavaScript',
    github: 'https://github.com/NeoKazaki/Portfolio',
    demo: '',
...
// Version bump forces a full reset of projects
  ...
  const seedData = [
    {
      ...
      desc: 'This is a School Artwork that I made in our ART APPRECIATION Subject on February 20, 2024',
      tools: 'Copic Markers',
      image: 'The Chamelion.jpg',
      dateAdded: 'April 25, 2026'
    },
    {
      title: 'Circles',
      category: 'digital',
      desc: "This mini WIP Artwork is based on My OC and the OC's of my Friends",
    ...
    },
    {
      title: 'Wikang Pinoy',
      category: 'traditional',
      desc: 'This is the Artwork that I made during the Buwan ng Wika on STI College Naga participating on the Poster Making Contest on August 30, 2024',
      tools: 'Copic Markers and Pencils',
      image: 'Wikang Pinoy.jpg',
      dateAdded: 'April 25, 2026'
    },
    {
      title: 'Artist Boy',
      category: 'character',
      desc: 'I made this art when I was practicing my Digital Tracing Art back on 2021',
      tools: 'IbisPaintX',
      image: 'Artist Boy.jpg',
      dateAdded: 'April 25, 2026'
    },
    {
      title: 'Lion and Dino',
      category: 'digital',
      desc: 'This Artwork is based on the OC of my friends as they wanted me to Commission it for them.',
      tools: 'Medibang Paint',
      image: 'Lion and Dino.png',
      dateAdded: 'April 25, 2026'
    },
    {
      title: 'Solemn of Tranquility',
      category: 'traditional',
      desc: 'This artwork resembles the peaceful greenery fields and the serenity silents of the river, I made this canvas during the Art Exhibit on June 11, 2024 at STI College Pasay Edsa',
      tools: 'Canvas and Alcohol Markers',
      image: 'Solemn of Tranquility.jpg',
      dateAdded: 'April 25, 2026'
    },
    {
      title: 'Family Collage',
      category: 'collage',
      desc: 'I created this Collage during the Holliweek event of Prosesyon in Calabanga Camarines sur on April 3, 2026',
      tools: 'Sony Camera and SCRL App',
      image: 'Family Collage.jpg',
      dateAdded: 'April 25, 2026'
    },
    {
      title: 'Athena',
      category: 'traditional',
      desc: 'This Artwork is based on Greek Goddess Athena that I made during INKtober on October 14, 2022',
      tools: 'Pencil and Ballpen',
      image: 'Athena.jpg',
      dateAdded: 'April 25, 2026'
    }
  ];

  // Force-update each entry by title so changes always apply
  seedData.forEach(seed => {
    const idx = existing.findIndex(a => a.title === seed.title);
    if (idx === -1) {
      existing.push(seed);
    } else {
      // Only overwrite if it's still using old placeholder data
      if (existing[idx].tools === 'Medibang Paint' && seed.title === 'Athena') {
        existing[idx] = seed;
      }
    }
  });
